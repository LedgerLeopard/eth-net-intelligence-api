...
const WS_SECRET = process.env.WS_SECRET || "eth-net-stats-has-a-secret";
const MAX_BLOCKS_HISTORY = process.env.MAX_BLOCKS_HISTORY || 10;
const UPDATE_INTERVAL = process.env.UPDATE_INTERVAL || 10000;
const PING_INTERVAL = process.env.PING_INTERVAL || 10000;
const MAX_HISTORY_UPDATE = process.env.MAX_HISTORY_UPDATE || 50;
const MAX_CONNECTION_ATTEMPTS = process.env.MAX_CONNECTION_ATTEMPTS || 50;
const CONNECTION_ATTEMPTS_TIMEOUT = process.env.CONNECTION_ATTEMPTS_TIMEOUT || 1000;
const WEBSOCKET_CONNECTION_TIMEOUT = process.env.WEBSOCKET_CONNECTION_TIMEOUT || 120000;
const WEBSOCKET_CONNECTION_RETRIES = process.env.WEBSOCKET_CONNECTION_RETRIES || 30;

let socket;

let Socket = Primus.createSocket({
    transformer: 'websockets',
    pathname: '/api',
    timeout: WEBSOCKET_CONNECTION_TIMEOUT,
    strategy: 'disconnect,online,timeout',
    reconnect: {
        retries: WEBSOCKET_CONNECTION_RETRIES
    },
